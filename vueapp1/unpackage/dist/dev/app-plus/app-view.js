...
var tM=_mz(z,'form',['bindsubmit',2,'data-event-opts',1],[],e,s,gg)
var eN=_n('view')
_rz(z,eN,'class',4,e,s,gg)
var bO=_mz(z,'input',['class',5,'placeholder',1,'type',2],[],e,s,gg)
_(eN,bO)
_(tM,eN)
var oP=_n('view')
_rz(z,oP,'class',8,e,s,gg)
var xQ=_mz(z,'input',['password',-1,'class',9,'placeholder',1,'type',2],[],e,s,gg)
_(oP,xQ)
_(tM,oP)
_(aL,tM)
_(lK,aL)
